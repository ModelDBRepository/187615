...
""")
  ...
  for igene in range(0,len(MT)):
   for imut in range(0,len(MT[igene])):
    ...
    for iallmutval in range(0,cumprodnVals[len(MT[igene][imut])-1]):
      ...
      if exists('ifcurves_cs'+str(icell)+'_'+str(igene)+'_'+str(imut)+'_'+str(iallmutval)+'.sav'):
        continue
  ...
  """+mutvar+""" = """+str(newVal[whichDefVal[iupdated]])+"""
        ...
        if iter == -1:
          picklelist = [ISIs,spTimesThisCoeff,spTimesThisCoeff2,Is,MT]
          file = open('ifcurves_cs'+str(icell)+'_control.sav', 'w')
      ...
      picklelist = [ISIs_thismutval,spTimesThisVal,spTimesThisVal2,Is,MT]
      file = open('ifcurves_cs'+str(icell)+'_'+str(igene)+'_'+str(imut)+'_'+str(iallmutval)+'.sav', 'w')
      pickle.dump(picklelist,file)
      file.close()
